...
def run_test_problem1a():
    ...
    answer = problem1a(40, 50)
    print()
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 4:
    expected = -0.468  # This is APPROXIMATELY the correct answer.
    answer = problem1a(20, 30)
    print()
...
def run_test_problem1b():
    ...
    answer = problem1b(1, 3)
    print()
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 291  # This is APPROXIMATELY the correct answer.
    answer = problem1b(40, 50)
    print()
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 101  # This is APPROXIMATELY the correct answer.
    answer = problem1b(20, 30)
    print()
